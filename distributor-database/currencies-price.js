...
function updateCurrenciesPrice() {
    ...
    console.log({msg: 'Bitcoin price set', data: {value: bitcoinPrice}});
    ...
    console.log({msg: 'Ethereum price set', data: {value: ethereumPrice}});

    PARAMETERS_SHEET.sheet.getRange(PARAMETERS_SHEET.currenciesPriceLastUpdateDateCell).setValue(new Date());
    console.log({msg: 'Last currencies price update date set', data: {value: new Date()}});
}
